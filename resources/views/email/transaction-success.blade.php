                        ...
                        <tbody>
                          <tr>
                            <td style="width:150px;">
                              <img alt="" height="auto" src="{{ url('frontend/images/logo/logo_nomads@2x.png')}}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150" />
                            </td>
                          </tr>
                        </tbody>
                      </table>
          ...
          <![endif]-->
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                  <tbody>
                    <tr>
                      <td style="border-bottom:1px dashed #eeeeee;vertical-align:middle;padding-bottom:30px;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:20px;word-break:break-word;">
                          ...
                          <tr>
                            <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:20px;word-break:break-word;">
                              <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071C4D;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:25px;table-layout:auto;width:100%;border:none;">
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td style="text-align: right;">{{ $item->nasionality }}</td>
                                </tr>
                                @endforeach
                              </table>
                            </td>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                        <tr>
                          <td style="width: 50px;">
                            <image src="{{ url('frontend/images/icon/bantuan@2x.png')}}" width="50px">
                          </td>
                          <td style="font-size: 18px; padding-left: 5px; color: #071C4D; font-family: Assistant, Helvetica, Arial, sans-serif"> support@nomads.id <br> 021-1234 5678 </td>
                        </tr>
                      </table>
                    </td>
                  </tr>
