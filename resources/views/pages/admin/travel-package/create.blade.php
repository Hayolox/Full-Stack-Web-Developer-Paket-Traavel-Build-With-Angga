      ...
      <div class="card-body">
        <form action="{{ route('travel-package.store') }}" method="POST">
          ...
          <div class="form-group">
            <label for="title">Title</label> {{-- tidak masalah dgn penggunaan <label> --}}
            <input type="text" class="form-control" name="title" placeholder="Title" value="{{ old('title') }}">
            {{-- old=data yang lama, kalau user mlkkan input lalu ada yg salah/error data tsb tidak akan hilang --}}
          </div>
          <div class="form-group">
            <label for="location">Location</label> {{-- tidak masalah dgn penggunaan <label> --}}
